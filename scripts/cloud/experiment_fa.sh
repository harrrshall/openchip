...
set -uo pipefail
. /home/openchip-env/env.sh; . /home/openchip-env/secrets.env; . /home/openchip-env/model.env
...
run_cfg B 1 1
run_cfg C 0 1
echo "== experiment done $(date -u +%T)"; touch $OUT/DONE
